...
function SchedulePanel({ setGlobalError }) {
  ...
  const [shiftForm, setShiftForm] = useState({ name: "烘焙早班", department: "烘焙坊", startTime: "08:00", endTime: "16:00", graceMinutes: DEFAULT_GRACE_MINUTES, isFlexible: false, isRest: false });
