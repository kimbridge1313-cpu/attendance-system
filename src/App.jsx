...
function SalaryPanel({ setGlobalError }) {
  ...
  const rows = employees.flatMap((emp) => {
    ...
    return targetDepartments.map((department) => {
      ...
      const totalMinutes = departmentRecords.reduce((sum, r) => sum + Number(r.workMinutes || 0), 0);
